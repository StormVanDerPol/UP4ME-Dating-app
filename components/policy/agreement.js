                ...
                <ScrollView>
                    ...
                    <View style={[gs.grayTextBox, s.textContainer]}>
                        ...
                        <View style={s.section}>
                            ...
                            {/* <ListItem symbol={"1."} text={""} />
                            <ListItem symbol={"2."} text={""} />
                            <ListItem symbol={"3."} text={""} />
                            <ListItem symbol={"4."} text={""} />
                            <ListItem symbol={"5."} text={""} />
                            <ListItem symbol={"6."} text={""} />
                            <ListItem symbol={"7."} text={""} />
                            <ListItem symbol={"8."} text={""} />
                            <ListItem symbol={"9."} text={""} /> */}
